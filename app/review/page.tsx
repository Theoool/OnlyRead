    ...
    return (
      <div className="h-screen flex items-center justify-center bg-zinc-100 dark:bg-black">
        <div className="flex flex-col items-center gap-4">
          ...
          <p className="text-zinc-400 font-medium animate-pulse">加载复习会话...</p>
        </div>
      </div>
    );
  }
        ...
        >
            <div className="bg-white dark:bg-zinc-900 rounded-3xl shadow-2xl border border-zinc-200 dark:border-zinc-800 overflow-hidden min-h-[400px] flex flex-col">
                        ...
                        >
                            ...
                            <div className="p-6 bg-zinc-50 dark:bg-zinc-800/50 rounded-2xl border border-zinc-100 dark:border-zinc-800">
                                <div className="flex items-center gap-2 mb-3">
                                    ...
                                    <span className="text-xs font-bold uppercase tracking-wider text-zinc-400">你的记忆</span>
                                </div>
                            ...
                            <div className="p-6 bg-purple-50 dark:bg-purple-900/10 rounded-2xl border border-purple-100 dark:border-purple-900/20">
                                <div className="flex items-center gap-2 mb-3">
                                    ...
                                    <span className="text-xs font-bold uppercase tracking-wider text-purple-400">AI 参考</span>
                                </div>
                                <p className="text-zinc-800 dark:text-zinc-200 leading-relaxed">
                                    {aiDefinition || "加载 AI 定义..."}
                                </p>
                            </div>
                        </motion.div>
                    )}
                ...
                {isFlipped && (
                    ...
                    >
                        <span className="text-sm text-zinc-400 font-medium uppercase tracking-widest">你的回忆如何？</span>
